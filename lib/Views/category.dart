...
class Categories extends StatefulWidget {
  ...
  const Categories({this.categoriName});
  @override
...
class _CategoriesState extends State<Categories> {
  ...
  Future<dynamic>  searchWallpaper(String query) async {return http.get("https://wallpro.herokuapp.com/add/catsearch?qname=$query").then((http.Response response){
  ...
  @override
  void initState() {
    searchWallpaper(widget.categoriName);
    super.initState();
  }
